...
public class ClientJabberActivity extends Activity {
	...
	private final static String SERVER_HOST = "192.168.1.96";
	private final static int SERVER_PORT = 5298;
	private final static String SERVICE_NAME = "asusU36SD-2";	
	private final static String LOGIN = "antoine@HTCEVO3D";
	...
	private void initConnection() throws XMPPException {
        ...
        m_connection = new XMPPConnection(new ConnectionConfiguration(SERVER_HOST, SERVER_PORT));
        m_connection.connect();
        m_connection.loginAnonymously();
