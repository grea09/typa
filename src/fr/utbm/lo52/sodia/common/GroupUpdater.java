...
public final class GroupUpdater
{
	...
	public static void magicUpdate(boolean contains, Object element, Object group)
	{
		boolean isAdd = (new Exception()).getStackTrace()[1].getMethodName().startsWith(Operation.ADD.prefix());
