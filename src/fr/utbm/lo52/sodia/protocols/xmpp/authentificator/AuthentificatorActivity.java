...
public class AuthentificatorActivity extends AccountAuthenticatorActivity
{
	...
	public void onCreate(Bundle icicle) {
		...
		getWindow().setFeatureDrawableResource(
				Window.FEATURE_LEFT_ICON, R.drawable.ic_protocol_xmpp);
		getWindow().setTitle("XMPP");
...
*/
    ...
    public void handleLogin(View view) {
        ...
        if (TextUtils.isEmpty(username) )//|| TextUtils.isEmpty(password)) {
        {
            ...
            //authTask.execute();
        	final Account account = new Account(username, "org.xmpp");
            if (requestNewAccount) {
            ...
            intent.putExtra(AccountManager.KEY_ACCOUNT_TYPE, "org.xmpp");
